...
BuildRequires : libdrm-staticdev32
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622284075
unset LD_AS_NEEDED
...
sd "/usr/lib64" "/usr/lib32" $(fd -uu --glob *.ninja)
sd "/usr/lib32/libz3.a" "/usr/lib32/libz3.so" $(fd -uu --glob *.ninja)
## make_prepend32 end
ninja --verbose %{?_smp_mflags} -v -C builddir
popd
